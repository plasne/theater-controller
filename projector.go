...
func turnProjectorOff() error {
	...
	return sendProjectorFunc(func(conn net.Conn) error {
		...
		err := sendProjectorCmd(conn, fmt.Sprintf("sendir,%v:1,1,38000,1,1,22,22,22,64,22,22,22,22,22,22,22,22,22,22,22,64,22,64,22,22,22,64,22,64,22,64,22,64,22,64,22,22\r", projectorIrPort))
		return err
	})
}
