...
func turnProjectorOff() error {
	...
	return sendProjectorFunc(func(conn net.Conn) error {
		...
		//err := sendProjectorCmd(conn, fmt.Sprintf("sendir,%v:1,1,38000,1,1,347,173,22,65,22,65,22,22,22,22,22,22,22,22,22,22,22,65,22,65,22,22,22,65,22,22,22,65,22,22,22,65,22,22,22,65,22,22,22,22,22,22,22,22,22,65,22,22,22,65,22,22,22,65,22,65,22,65,22,65,22,22,22,65,22,22,22,1570\r", projectorIrPort))
		//err := sendProjectorCmd(conn, fmt.Sprintf("sendir,%v:1,1,38000,1,137,341,171,22,64,22,64,22,22,22,22,22,22,22,22,22,22,22,64,22,64,22,22,22,64,22,22,22,64,22,22,22,64,22,22,22,22,22,64,22,22,22,22,22,22,22,22,22,22,22,64,22,64,22,22,22,64,22,64,22,64,22,64,22,64,22,22,22,1557\r", projectorIrPort))
		err := sendProjectorCmd(conn, fmt.Sprintf("sendir,%v:1,1,38000,1,137,341,171,22,64,22,64,22,22,22,22,22,22,22,22,22,22,22,64,22,64,22,22,22,64,22,22,22,64,22,22,22,64,22,22,22,22,22,64,22,22,22,22,22,22,22,22,22,22,22,64,22,64,22,22,22,64,22,64,22,64,22,64,22,64,22,22,22,1557\r", projectorIrPort))
		return err
	})
}
